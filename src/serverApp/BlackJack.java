...
public class BlackJack extends Thread{
    ...
    gameServer.Player player = null;
    private gameServer.ServerCards dealer = null;
    private gameServer.RoomThread parent = null;
    private static gameServer.ServerScore server_score = new ServerScore();
	...
	private void initializeHand(){		
		ArrayList<gameServer.Card> cards = (ArrayList<Card>) dealer.draw(2);
