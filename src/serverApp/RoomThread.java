...
import gameServer.BlackJack;
import gameServer.Host;
import gameServer.Player;
import gameServer.ServerJudge;
...
public class RoomThread extends Thread {
	...
	private ConcurrentLinkedQueue<gameServer.Player> player_waiting = new ConcurrentLinkedQueue<Player>();
	gameServer.Host host = null;
	private ArrayList<gameServer.BlackJack> threads = new ArrayList<BlackJack>();
	...
	private void notifyResult(){
		...
		gameServer.ServerJudge judge = new ServerJudge();
